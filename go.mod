...
replace github.com/anycable/anycable-go => github.com/anycable/anycable v1.6.1

require (
	github.com/anycable/anycable-go v1.6.1
...
require (
	...
	github.com/posthog/posthog-go v1.4.7 // indirect
